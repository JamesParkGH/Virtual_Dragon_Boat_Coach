...
while cap.isOpened():
    ...
    ## Track positions
    wrist1 = results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_WRIST]
    wrist2 = results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_WRIST]
